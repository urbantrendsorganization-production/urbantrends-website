...
export default function CheckOut() {
    ...
    const removeFromCart = (id) => {
        ...
        toast.info("Removed item (placeholder)");
    };

    const updateQuantity = (id, newQty) => {
        console.log("Update qty:", id, newQty);
        toast.info("Updated quantity (placeholder)");
    };
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between gap-4 mb-2">
                                            ...
                                            <Button
                                                ...
                                                className="text-gray-600 hover:text-slate-800 hover:bg-gunmetal flex-shrink-0"
                                            >
                                        ...
                                        <div className="flex items-center justify-between mt-4">
                                            <div className="flex items-center gap-2">
                                                <Button
                                                    ...
                                                    className="h-8 w-8 border-dim-grey text-slate-800 hover:border-slate-600"
                                                >
