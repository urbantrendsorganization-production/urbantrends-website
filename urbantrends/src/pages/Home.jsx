  ...
  return (
    <>
      <div className="p-4 space-y-5 overflow-hidden mt-18 md:mt-10">
        {/* HERO SECTION */}
        <section
  className="relative rounded-lg flex flex-col items-center text-center overflow-hidden mt-6 py-16 sm:py-20 md:py-28"
>
          ...
          <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-light leading-snug font-tech tracking-tight drop-shadow-sm">
            ...
            That{" "}
            <span className="font-bold font-tech bg-gradient-to-r from-gray-900 via-slate-700 to-gray-400 bg-clip-text text-transparent animate-pulse-slow">
              Drive Growth
            </span>
          </h1>
          ...
          <p className="mt-5 text-sm sm:text-base md:text-lg text-[#6B6B6B] max-w-2xl mx-auto px-4 font-tech leading-relaxed">
            At UrbanTrends, we design and develop high-performance websites,
            apps, and tools that help businesses scale, connect, and thrive in
            the digital era.
          </p>
